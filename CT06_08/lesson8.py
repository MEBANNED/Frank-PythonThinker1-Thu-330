...
# 2. generate 2 random numbers between 1 and 50
# 3. ask user to add the 2 numbers together and input their answer
# 4. check if user's answer is correct by comparing it to the sum of the 2 random numbers
# 5. print 'True' if user's answer is correct, otherwise print 'False'
import random
