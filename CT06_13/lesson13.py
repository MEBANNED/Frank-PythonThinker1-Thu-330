...
8. Honey
"""
grocery_list = ["Apples", "Bread", "Carrots", "Dates", "Eggs", "Flour", "Grapes", "Honey"]  
...
4. If name == "Grapes", print "<grocery name>: Get the FarmFresh
   brand"
"""
# for teacher_alson in range(len(grocery_list)):
#     print(grocery_list[teacher_alson])
#     if grocery_list[teacher_alson] == "Apples":
#         print(str(grocery_list[teacher_alson]) + "I will need five of these")
#     elif grocery_list[teacher_alson] == "Carrots":
#         print(f"{grocery_list[teacher_alson]}: I will need three of these ")
#     elif grocery_list[teacher_alson] == "Grapes":
#         print("Grapes: I NEED YOU TO BUY THE ONE FROM NTUC FARMFERSH OR ELSE")
#     else:
#        print(grocery_list[teacher_alson])
"""
-------------------------------------------------------------------
...
# while True:
#     item = input("what item have you added to you list? \n")
#     if item == "end":
#         break
#     grocery_list.append(item)

# for teacher_alson in range(len(grocery_list)):
#     print(f"I have bought {grocery_list[teacher_alson]}")
...
"""
ask = input("Type here what you are looking for:\n")

if ask in catalogue:
    print("Yes, we sell that, that would be $999999999999")
else:
    print("OMG WE DON'T HAVE IT! IF YOU WANT IT YOU CAN PAY $9999999999999999999999999999")
